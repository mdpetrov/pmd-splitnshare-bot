...
_TEXTS: dict[Language, dict[str, str]] = {
    Language.ENGLISH: {
        ...
        "friend_already_added": "{name} is already in your Friends list.",
    ...
    Language.RUSSIAN: {
        ...
        "language_unavailable": "Этот язык временно недоступен.",
        ...
        "back_to_activity": "Назад к активности",
        ...
        "friend_already_added": "{name} уже находится в вашем списке друзей.",
