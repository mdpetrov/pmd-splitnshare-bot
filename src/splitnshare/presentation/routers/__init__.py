...
from splitnshare.presentation.routers.people import router as people_router
...
def build_router() -> Router:
    ...
    router.include_routers(start_router, settings_router, expenses_router, people_router)
